...
bool UOpenCVSubLib::importDLL(FString folder, FString name)
{
...
bool UOpenCVSubLib::importMethodGetInvertedBool()
{
    if (v_dllHandle != NULL)
    {
...
bool UOpenCVSubLib::importMethodGetIntPlusPlus()
{
    if (v_dllHandle != NULL)
    {
...
bool UOpenCVSubLib::importMethodGetCircleArea()
{
    if (v_dllHandle != NULL)
    {
...
bool UOpenCVSubLib::importMethodGetCharArray()
{
    if (v_dllHandle != NULL)
    {
...
bool UOpenCVSubLib::importMethodGetVector4()
{
    if (v_dllHandle != NULL)
    {
...
bool UOpenCVSubLib::getInvertedBoolFromDll(bool boolState)
{
    if (m_getInvertedBoolFromDll != NULL)
    {
...
int UOpenCVSubLib::getIntPlusPlusFromDll(int lastInt)
{
    if (m_getIntPlusPlusFromDll != NULL)
    {
...
float UOpenCVSubLib::getCircleAreaFromDll(float radius)
{
    if (m_getCircleAreaFromDll != NULL)
    {
...
FString UOpenCVSubLib::getCharArrayFromDll(FString parameterText)
{
    if (m_getCharArrayFromDll != NULL)
    {
...
FVector4 UOpenCVSubLib::getVector4FromDll(FVector4 vector4)
{
    if (m_getVector4FromDll != NULL)
    {
